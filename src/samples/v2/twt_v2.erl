                          ...
                          #een_children_config{
                              ...
                              children = [{#een_component_spec{id = store,
                                          ...
                                          {#een_component_spec{id = tracer,
                                                               version = removed},
                                           #een_children_config{version = removed}},
                                          {#een_component_spec{id = tracer2,
                                                               version = new,
                                                               module = een_java,
                                                               args = [make_node(een_java), "com.erleen.samples.Tracer", [{2, 100}]]},
                                           #een_children_config{version = new}}],
                              bindings = [{{twtr, new_user}, {users, new_user}},
                                          ...
                                          {{call_split, out_cast}, {tracer2, msg}}]}}],
